    ...
    <div className="stats-screen">
      <div className="stats-panel overlay-panel stats-panel-wide">
        ...
        <div className="stats-scroll">
          ...
          <div className="settings-section-title stats-section-title">Full Rankings</div>
          ...
          {specialAwards.length > 0 && (
            <>
              <div className="settings-section-title stats-section-title">Special Awards</div>
          ...
          <div className="stats-charts">
            <div className="stats-chart-panel">
              <div className="settings-section-title stats-section-title">Your Journey</div>
            ...
            {winner && playerResult && (
              <div className="stats-chart-panel">
                <div className="settings-section-title stats-section-title">Radar Chart</div>
                <p className="stats-chart-hint">
